...
public class bodythreedetail extends AppCompatActivity {
        int bodytype_img;
        String name;
        Button Counttime;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_bodythreedetail);
                    ...
                    if (!timeon) {
                        ...
                        new CountDownTimer(20000, 1000) {
                            ...
                            public void onFinish() {
                                ...
                                Toast.makeText(com.example.massage.bodythreedetail.this, "請舒緩按摩處!", Toast.LENGTH_LONG)
                                        .show();
                            }
                        }.start();
                    } else {
                        Toast.makeText(com.example.massage.bodythreedetail.this, "finish!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
            });
